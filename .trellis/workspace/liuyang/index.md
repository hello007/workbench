...
| 57 | 2026-09-13 | 外部 diff 工具集成 | `539069f`, `87f6db9`, `e046ef4` | `master` |
...
| 38 | 2026-09-09 | AI skill 自动发现与一键导入（第 4 批） | `3d32ef5` | `master` |
| 37 | 2026-09-09 | AI 第 3 批：运行历史归档 + 大输出流式文件 | `61455a9` | `master` |
| 36 | 2026-09-09 | AI 配置表单化 + MCP stdio 支持（第 2 批） | `d6ef191` | `master` |
| 35 | 2026-09-08 | AI 执行链路增强第 1 批：可观测性 + 并发上限 + 输出截断 | `644f5ea` | `master` |
| 34 | 2026-09-08 | AI 功能菜单（Skill 聚合触发器）全量实现 | `a7648c8` | `master` |
| 33 | 2026-09-07 | spec 沉淀迁出 .trellis/spec 至 docs/spec | `531dc81` | `master` |
...
| 6 | 2026-06-23 | PDF 内嵌预览（pdfjs viewer + iframe，规避双实例） | `9d36bdb` | `master` |
| 5 | 2026-06-23 | 文件类型预览功能（图片/文本/Office 内嵌 + PDF 降级） | `bead5c7` | `master` |
| 4 | 2026-06-23 | 新增用 Obsidian 打开入口与文件预览渲染增强 | `095a6ab`, `bead5c7` | `master` |
| 3 | 2026-06-10 | 修复文件树拷贝到后展开节点被收起 | `185ef0b`, `49de4e4` | `master` |
| 2 | 2026-06-10 | 实现检查更新与自动更新功能 | `88a6efe`, `fc98c91` | `master` |
| 1 | 2026-06-10 | GitHub Actions 自动打包发版流水线 | `26ecf7e` | `master` |
<!-- @@@/auto:session-history -->
